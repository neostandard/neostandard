...
const plugin = /** @type import('@typescript-eslint/utils/ts-eslint').FlatConfig.Plugin */ (tseslint.plugin)
const parser = /** @type import('@typescript-eslint/utils/ts-eslint').FlatConfig.Parser */ (tseslint.parser)
