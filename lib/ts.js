 ...
 * @property {import('@typescript-eslint/utils/ts-eslint').FlatConfig.FileSpec[]} [files]
 * @property {string[] | string | boolean | null | undefined} [project]
 ...
 */
export function typescriptify (configs, options) {
  const {
    files = ['**/*.{js,mjs,cjs,ts}'],
    project,
    tsconfigRootDir,
