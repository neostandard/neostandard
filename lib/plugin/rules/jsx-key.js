...
/** @typedef {import('../jsx-types.js').JSXElement} JSXElement */
/** @typedef {import('../jsx-types.js').JSXFragment} JSXFragment */
/** @typedef {import('../jsx-types.js').JSXOpeningElement} JSXOpeningElement */
...
/**
 * One of the untyped→typed boundaries (see also `isJSXFragment`): ESLint/espree
 * emit JSX nodes that `@types/estree` does not type, so we narrow `unknown` to
 * our local typedefs here.
 * @param {unknown} node
...
const rule = /** @satisfies {import('eslint').Rule.RuleModule} */(/** @type {const} */({
  meta: {
    type: 'problem',
    docs: {
