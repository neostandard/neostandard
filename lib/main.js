 ...
 * @property {boolean|import('./react').ReactConfigName|import('./react').ReactConfig|undefined} [react] = when set, enables React checks, using selected config or 'react/recommended', see {@link https://www.npmjs.com/package/eslint-plugin-react|React plugin Docs}
 */
...
function neostandard (options) {
  ...
  return [
    ...
    ...ts
      ...
      : [],
    ...react
      ? reactify(react === true ? 'recommended' : react, {
        ignores,
